  ...
  var Crud = () => {
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        instance.t("translation.translateToFrench")
      ),
      React.createElement(
        "button",
        { onClick: toggleHighContrastMode },
        instance.t("translation.toggleHighContrastMode")
      ),
      React.createElement("h1", null, instance.t("translation.crudOperations")),
      React.createElement(
        "form",
        { onSubmit: createUser },
        React.createElement("label", null, instance.t("translation.name")),
        React.createElement("input", { type: "text", id: "name" }),
        React.createElement("br", null),
        React.createElement("label", null, instance.t("translation.email")),
        React.createElement("input", { type: "email", id: "email" }),
        React.createElement("br", null),
        React.createElement("button", { type: "submit" }, instance.t("translation.create"))
      ),
      React.createElement(
        "ul",
        null,
        users.map((user) => React.createElement(
          ...
          React.createElement(
            ...
            React.createElement("button", { type: "submit" }, instance.t("translation.update"))
          ),
          React.createElement("button", { onClick: () => deleteUser(user._id) }, instance.t("translation.delete"))
        ))
      )
    );
  };
